...
{
    public partial class spiizdel : Form
    {
        public spiizdel()
        {
            InitializeComponent();
        ...
        DataSet ds;
        SqlDataAdapter sda;
        Form f1 = Application.OpenForms["mened"];
        private void spiizdel_Load(object sender, EventArgs e)
        {
            ...
            String query = "select [id],[Артикул],[Наименование],[Ширина],[Длина],[Комментарий] from изделия";
            sqlcon.Open();
            ...
            for (int i = 0; i < dataGridView1.RowCount; i++)
            {
                if (dataGridView1.Rows[i].Cells[1].Value != null)
                {
                    ...
                    if (File.Exists(@"C:\Users\User15\gitpr\pr\WpfApp1asds\WpfApp1asds\izobr\izdel\" + filename))
                    {

                        image = Image.FromFile(@"C:\Users\User15\gitpr\pr\WpfApp1asds\WpfApp1asds\izobr\izdel\" + filename);
                    }
                    else
                    {
        ...
        private void spiizdel_FormClosing(object sender, FormClosingEventArgs e)
        {
            f1.Show();
        ...
        private void spiizdel_SizeChanged(object sender, EventArgs e)
        {

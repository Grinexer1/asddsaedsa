...
namespace WpfApp1asds
{
    public partial class fur : Form
    {
        ...
        private void fur_Load(object sender, EventArgs e)
        {
            ...
            String query = "select [id],[Артикул],[Наименование],[Ширина],[Длина],[Тип],[Цена] from Фурнитура";
            sqlcon.Open();
            ...
            for (int i = 0; i < dataGridView1.RowCount; i++)
            {
                if (dataGridView1.Rows[i].Cells[1].Value != null)
                {
                    ...
                    {
                        if(File.Exists(@"C:\Users\User15\gitpr\pr\WpfApp1asds\WpfApp1asds\izobr\furn\"+ dataGridView1.Rows[i].Cells[1].Value.ToString() + ".png"))
                        {
                            image = Image.FromFile(@"C:\Users\User15\gitpr\pr\WpfApp1asds\WpfApp1asds\izobr\furn\" + dataGridView1.Rows[i].Cells[1].Value.ToString() + ".png");
                        }
                        else
                        {
